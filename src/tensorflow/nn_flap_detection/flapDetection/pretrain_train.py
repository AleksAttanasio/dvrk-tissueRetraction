...
dataset_name = os.path.join('tissue_dataset', 'pretrain_set')

img_dir = os.path.join(dataset_name, "train")
label_dir = os.path.join(dataset_name, "lab")

df_train = pd.read_csv(os.path.join(dataset_name,'pretrain.csv'))
...
save_model_path = '/tmp/pretrained_net.hdf5'
