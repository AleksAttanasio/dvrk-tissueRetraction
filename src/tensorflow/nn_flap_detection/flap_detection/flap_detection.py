...
batch_size = 60             # Batch size for training (decrease in case of memory error)
epochs = 600                # Training epochs
testset_size = 0.10         # Percentage of training set data (0.10 = 10%)
dropout_rate = 0.1          # Droput rate
num_filters = 64            # Number of neurons in first layer (subsequent layers have x2 neurons)
learning_rate = 0.0000005       # Learning rate tuning for optimizer
