...
% % right_R = quat2rotm([right_tf.Rotation.X, right_tf.Rotation.Y, ...
% %                             right_tf.Rotation.Z, right_tf.Rotation.W]);
...
T_left_center = [[eye(3); 0 0 0], [0; 0.005; 0; 1]];
...
% plot frames 
figure
frame3d(p_center, T_cb_center(1:3, 1:3))
hold on 
frame3d(or_pos, or_rot)
hold on
frame3d(p_left, T_cb_center(1:3, 1:3))
