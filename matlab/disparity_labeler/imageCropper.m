...
for i = 0 : 1000
    ...
    I_left = imread(strcat('left/',left_img_name));
    I_right = imread(strcat('right/',right_img_name));
    I_disp = imread(strcat('disp_color/',disp_img_name));
    ...
    imwrite(I_disp, strcat('cropped/disp_color/', right_img_name));
